...
public interface UserManager extends GenericManager<User, Long> {
    ...
    /**
     * Returns users if Enabled.
     *
     * @param user the user's information
     * @throws UserExistsException thrown when user already exists
     * @return user the updated user object
     */
    List<User> getUsersByEnabled();
     ...
     * @return a list of matches, or all active user if no searchTerm.
     * @throws
     * org.springframework.security.core.userdetails.UsernameNotFoundException
     * thrown when searchTerm not found in database
     */
    List<User> search(String searchTerm) throws UsernameNotFoundException;

    /**
     * Saves a user's password information.
     *
     * @param user the user's information
     * @return user the updated user object
     */
