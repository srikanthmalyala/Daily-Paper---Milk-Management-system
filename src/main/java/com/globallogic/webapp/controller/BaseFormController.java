...
import com.globallogic.service.*;
import com.globallogic.service.impl.CustomerManagerImpl;
...
public class BaseFormController implements ServletContextAware {
    ...
    private PayBillManager payBillManager=null;    
    private CustomerItemManager customerItemManager=null;
    private CustomerManager customerManager=null;  
    private HoldDetailManager holdDetailManager = null;
    ...
    public CustomerItemManager getCustomerItemManager() {
        return customerItemManager;
    }

    @Autowired 
    public void setCustomerItemManager(CustomerItemManager customerItemManager) {
        this.customerItemManager = customerItemManager;
    }
   ...
   public PayBillManager getPayBillManager() {
        return payBillManager;
    }
   ...
   @Autowired
    public void setPayBillManager(PayBillManager payBillManager) {
        this.payBillManager = payBillManager;
    }
   ...
   @Autowired
    ...
    protected void sendUserMessage(User user, String msg, String url) {
        ...
        // WebWork, then figure it out here too.  In the meantime, the Employee Id
