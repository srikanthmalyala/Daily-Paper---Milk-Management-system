...
<div class="divStyle">
    <form:form commandName="payment" method="post" onsubmit="return onFormSubmit(this)" id="milkForm" action="/admin/payment/">
        <form:hidden path="id"/>
        ...
        <ul> <table class="table1">   
                ...
                <tr><th>
                        <appfuse:label styleClass="desc" key="payment.customerID"/></th>
