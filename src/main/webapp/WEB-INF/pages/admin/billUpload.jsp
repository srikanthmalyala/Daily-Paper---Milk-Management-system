...
<div class="divStyle"/>
<form:form commandName="fileUpload" method="post" action="billUpload" enctype="multipart/form-data"
           onsubmit="return validateFileUpload(this)" id="uploadForm">
    <ul><table class="table1">
            <tr><td colspan="2" class="tdHead">
                    <fmt:message key="menu.selectUserFile"/></td></tr>
            <tr><th>
    ...
    <p class="message" style="width:88%"><fmt:message key="uploadUser.message"/></p>
