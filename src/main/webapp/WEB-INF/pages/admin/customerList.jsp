...
<div style=" width: 75%; margin: auto;">
    ...
    <display:table name="customerList" cellspacing="0" cellpadding="0" requestURI="" 
        ...
        <display:column property="deposit" sortable="true" titleKey="customer.deposit" style="width: 30%"/>
        <display:column property="phoneNo" escapeXml="true" sortable="true" titleKey="customer.phoneno" style="width: 15%" />  
        <display:column  property="disableUser" titleKey="customer.actions" sortable="true"  />      
